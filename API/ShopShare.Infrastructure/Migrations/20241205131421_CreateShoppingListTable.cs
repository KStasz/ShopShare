...
{
    /// <inheritdoc />
    public partial class CreateShoppingListTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ListName = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListItems", x => new { x.ListItemId, x.ShoppingListId });
                    table.ForeignKey(
